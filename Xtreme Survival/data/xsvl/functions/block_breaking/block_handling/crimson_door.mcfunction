...
scoreboard players set @s crimson_door_broken 0
...
execute at @e[type=item,nbt={Item:{id:"minecraft:crimson_door"}}] run function xsvl:block_breaking/loot/invalid_tool_nether_door
kill @e[type=item,nbt={Item:{id:"minecraft:crimson_door"}}]