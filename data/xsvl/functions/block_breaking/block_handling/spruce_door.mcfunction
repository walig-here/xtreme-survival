...
scoreboard players set @s spruce_door_broken 0
...
execute at @e[type=item,nbt={Item:{id:"minecraft:spruce_door"}}] run function xsvl:block_breaking/loot/invalid_tool_door
