...
scoreboard players set @s acacia_door_broken 0
...
execute at @e[type=item,nbt={Item:{id:"minecraft:acacia_door"}}] run function xsvl:block_breaking/loot/invalid_tool_door
kill @e[type=item,nbt={Item:{id:"minecraft:acacia_door"}}]