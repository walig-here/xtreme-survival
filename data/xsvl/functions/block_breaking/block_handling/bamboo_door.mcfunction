...
scoreboard players set @s bamboo_door_broken 0
...
execute at @e[type=item,nbt={Item:{id:"minecraft:bamboo_door"}}] run function xsvl:block_breaking/loot/invalid_tool_door
kill @e[type=item,nbt={Item:{id:"minecraft:bamboo_door"}}]