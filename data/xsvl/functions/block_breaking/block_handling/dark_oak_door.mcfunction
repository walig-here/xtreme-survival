...
scoreboard players set @s dark_oak_door_broken 0
...
execute at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_door"}}] run function xsvl:block_breaking/loot/invalid_tool_door
kill @e[type=item,nbt={Item:{id:"minecraft:dark_oak_door"}}]